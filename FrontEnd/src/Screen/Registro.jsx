...
const Formulario = () => {
  ...
  const manejarRegistro = async (e) => {
    ...
    try {
      ...
      setMensaje('Registro exitoso. ¡Bienvenido! Se ha enviado un correo de verificación a ' + datosFormulario.email);
    } catch (error) {
      ...
      <div className="container">
        <div className="left-section">
         ...
         <div className="form-container">
                                  ...
                                  <h2 className="center-title">Formulario de Registro</h2><br></br>
